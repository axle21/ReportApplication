          ...
          <div class="col-lg-8">
            ...
            <div class="box box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">PO Monitoring<i class="fa fa-area-chart" style="margin-left: 10px;"></i></h3>
              </div>
              ...
              <div class="form-horizontal" method="post" action="<?php echo base_url('main/'); ?>">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <button id="clear_customer" type="button" class="col-sm-1 btn btn-primary" style="width:30px; margin-top:3px; margin-left:5px;"><i class="fa fa-remove" style="margin-left:-5px;"></i></button>
                 </div>
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="col-sm-1 search_item btn btn-primary" style="width:30px; margin-top:3px; margin-left:-8px;" title='Search'><i class="fa fa-search" style="margin-left:-5px;"></i></button>
                    <button id="clear_item_code" type="button" class="col-sm-1 btn btn-primary" style="width:30px; margin-top:3px; margin-left:5px;"><i class="fa fa-remove" style="margin-left:-5px;"></i></button>
                </div>

                <div class="form-group">
                    <label class="col-sm-3 control-label" >WRR : </label>
                    <div class="col-sm-5">
                       <input list="itemlist" type="text" style='text-transform:uppercase;' class="form-control" name="wrr" id="wrr" autocomplete="off" style="text-transform:uppercase" required/>
                    
                    </div>
           <datalist id="itemlist"></datalist> 
               <!--  <button type="button" class="col-sm-1 search_wrr btn btn-primary" style="width:30px; margin-top:3px; 
                 margin-left:-8px;" title='Search'><i class="fa fa-search" style="margin-left:-5px;"></i></button>
-->
                </div>
  ...
  function setURL() {
    ...
    var ls_msg = "";
        ...
        alert("Please provide the following required field/s: "  + ls_msg);
          ...
          var report = "http://birt.amti.com.ph:8080/birt4-4/frameset?__report=AMTI_PO_MONITORING.rptdesign&start_date="+SnewDate +"&end_date="+EnewDate
          +"&po_number="+ po_number +"&vendor_name="+ vendor_name+"&po_item="+ item_number + "&wrr_no="+ wrr_no;
