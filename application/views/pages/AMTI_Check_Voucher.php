          ...
          <div class="col-lg-8">
            ...
            <div class="box box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">AMTI Check Voucher<i class="fa fa-area-chart" style="margin-left: 10px;"></i></h3>
              </div>
              ...
              <div class="form-horizontal" method="post" action="<?php echo base_url('main/'); ?>">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Check Voucher No. (From) : </label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="bs_num_from" placeholder="This is a required parameter" required/>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-3 control-label">Check Voucher No. (To) : </label>
                    <div class="col-sm-5">
                       <input type="text" class="form-control" id="bs_num_to" placeholder="This is a required parameter" required/>
                    </div>
                </div>
<!--
              <div class="form-group">
...
<script type="text/javascript">
  ...
  function setURL() {
    ...
    var bs_from = $("#bs_num_from").val();
    var bs_to = $("#bs_num_to").val();

      
        if(bs_from == null || bs_from == "" ){
          alert("Please enter BS Number.");
          exit();
        }
        else if( bs_to == null || bs_to == ""){
          alert("Please enter BS Number.");
          exit();
      }
        ...
        {
          var report = "http://birt.amti.com.ph:8080/birt4-4/frameset?__report=xx_amti_chkvoucher.rptdesign&bs_number_from="+bs_from +"&bs_number_to="+bs_to;
